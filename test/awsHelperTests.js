...
const s3Url2 = "https://s3-eu-west-1.amazonaws.com/pixlcrypt-content/users/patrik.palmer%40gmail.com/src/28973449265_07e3aa5d2e_b.jpg";
...
describe("isS3Url tests", () => {
    it("Should be a valid s3 url", () => {
        expect(awsHelper.isS3Url(s3Url));
    });
});
...
describe("isPresignPermitted tests", () => {
    it("Should be allowed to presign", () => {
        expect(awsHelper.isPresignPermitted(s3Url, "pixlcrypt@gmail.com")).to.be.true;
    });
